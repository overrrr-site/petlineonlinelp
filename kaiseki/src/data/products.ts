...
export const dogLineup = [
  { articleClass: 'element-2', buttonClass: 'button', href: dogCtaLinks.grainfree, sku: 'gU0815', name: 'グレインフリー 1歳から', descClass: 'text-wrapper-6', desc: '原材料として穀類不使用・タピオカ粉使用。たんぱく質34.5%以上（1歳から比 約140%）。', h3Class: 'text-wrapper-7', title: 'グレインフリー 1歳から', badgeClass: 'div-wrapper', badge: 'GRAIN-FREE', imgClass: 'thumb-kenbi', thumb: 'thumb-grainfree.png' },
  { articleClass: 'element-3', buttonClass: 'button-2', href: dogCtaLinks.senior, sku: 'gU0810', name: '7歳から', descClass: 'element-4', desc: 'シニア期向け。<br>たんぱく質20.5%以上/グルコサミン配合・コンドロイチン含有・高齢期のための健康設計※1。', h3Class: 'text-wrapper-9', title: '7歳から', badgeClass: 'frame-2', badge: 'SENIOR', imgClass: 'thumb-kenbi-2', thumb: 'thumb-7years.png' },
  { articleClass: 'element-5', buttonClass: 'button-3', href: dogCtaLinks.puppy, sku: 'gU0800', name: '子いぬ用 り乳から', descClass: 'element-DHA', desc: '成長期向け。<br>たんぱく質26.0%以上/カルシウム1.3%（1歳から比 約125%）/DHA+EPA 1900mg。', h3Class: 'text-wrapper-10', title: '子いぬ用 り乳から', badgeClass: 'frame-3', badge: 'PUPPY', imgClass: 'thumb-kenbi', thumb: 'thumb-puppy.png' },
  { articleClass: 'element-6', buttonClass: 'button', href: dogCtaLinks.adult, sku: 'gU0805', name: '1歳から', descClass: 'text-wrapper-6', desc: '成犬の毎日に。<br>たんぱく質23.0%以上/DHA+EPA 1800mg。', h3Class: 'text-wrapper-7', title: '1歳から', badgeClass: 'frame-4', badge: 'ADULT', imgClass: 'thumb-kenbi', thumb: 'thumb-adult.png' },
] as const;

// 犬 CTA の商品ボタン（4）。ラベル部は構造が不規則なため labelHtml を set:html で描画。
export const dogCtaCards = [
  { btnClass: 'button-dog-2', href: dogCtaLinks.grainfree, sku: 'gU0815', name: 'グレインフリー 1歳から', thumb: 'thumb-grainfree-card.png', thumbAlt: 'グレインフリー 1歳から 商品画像', badgeWrapClass: 'ADULT-wrapper', badge: 'GRAIN-FREE', labelHtml: '<div class="element-19">グレインフリー 1歳から</div>', aria: 'グレインフリー 1歳から の商品ページへ' },
  { btnClass: 'button-dog-3', href: dogCtaLinks.senior, sku: 'gU0810', name: '7歳から', thumb: 'thumb-7years-card.png', thumbAlt: '7歳から 商品画像', badgeWrapClass: 'frame-24', badge: 'SENIOR', labelHtml: '<div class="text-wrapper-57">7歳から</div>', aria: '7歳から の商品ページへ' },
  { btnClass: 'button-dog-4', href: dogCtaLinks.puppy, sku: 'gU0800', name: '子いぬ用 り乳から', thumb: 'thumb-puppy-card.png', thumbAlt: '子いぬ用 り乳から 商品画像', badgeWrapClass: 'frame-24', badge: 'PUPPY', labelHtml: '<p class="p"><span class="text-wrapper-58">子いぬ用 <br></span><span class="text-wrapper-59">り乳から</span></p>', aria: '子いぬ用 り乳から の商品ページへ' },
